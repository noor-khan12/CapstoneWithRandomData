...
Background: 
	...
	And user enter userName 'dummyemail1@gmail.com' and password 'dummyPassword' 
...
Scenario: Register as antaxID Affiliate user with Cheque Payment Method 
	When User click on ‘Register for an Affiliate Account’ link 
	And User fill affiliate form with below information 
		|company|website|taxID|paymentMethod|chequePayeeName|paypalEmail|
		|gulAnaar|gulanaar.com|45343949|paypal|Noor Khan|abd@xyz.com|
...
Scenario: 
	...
	And User fill Bank information with below information 
		...
		|TD Bank	|	45654	|4579797545	|savings	|9954594455		|
...
Scenario: Edit your account Information 
	...
	And User modify below information 
		...
		|Alhaj		|Alhajia	|alhaj@gmail.com	|420-840-2323	|
